...
Viewer::Viewer(GLFWwindow* window) : io(ImGui::GetIO()), style(ImGui::GetStyle())
{
...
void Viewer::renderOpenGL(GLFWwindow* window)
{
    int width, height;
